...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitBlock " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"www.bitblock.ml", "107.170.135.199"}, //seed node
    {"", "162.243.215.13"},
    {"", "162.243.128.168"},
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitBlock is probably already running."), addrBind.ToString().c_str());
        else
